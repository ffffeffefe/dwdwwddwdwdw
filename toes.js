...
document.addEventListener('DOMContentLoaded', function (event) {
  ...
  if (selectedValue === 'Google') {
    icon.setAttribute('href', 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/1024px-Google_%22G%22_logo.svg.png')
    name.textContent = 'Google'
    localStorage.setItem('name', 'Google')
    localStorage.setItem('icon', 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/1024px-Google_%22G%22_logo.svg.png')
  } else if (selectedValue === 'Drive') {
    icon.setAttribute('href', 'https://upload.wikimedia.org/wikipedia/commons/d/da/Google_Drive_logo.png')
    name.textContent = 'My Drive - Google Drive'
    localStorage.setItem('name', 'My Drive - Google Drive')
    localStorage.setItem('icon', 'https://upload.wikimedia.org/wikipedia/commons/d/da/Google_Drive_logo.png')
  } else if (selectedValue === 'Classroom') {
    icon.setAttribute('href', 'https://www.gstatic.com/classroom/favicon.png')
    name.textContent = 'Home'
    localStorage.setItem('name', 'Home')
    localStorage.setItem('icon', 'https://www.gstatic.com/classroom/favicon.png')
